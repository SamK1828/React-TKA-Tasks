...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-blue-300 flex flex-col items-center py-10 px-2">
      <h1 className="text-3xl font-bold text-blue-700 mb-8 drop-shadow-lg">Todo List</h1>
        ...
        <table className="min-w-full text-sm md:text-base">
          ...
          <tbody>
            {todos.map((rec) => (
              <tr
                key={rec.id}
                className="border-b last:border-none hover:bg-blue-100 transition-colors"
              >
